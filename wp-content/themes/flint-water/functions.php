...
function theme_enqueue_scripts() {
    if (is_page('email-search')) {  // Replace 'email-search' with the actual page slug or ID
        // Enqueue Bootstrap only on the email search page
        wp_enqueue_style('bootstrap-css', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css');
        wp_enqueue_script('bootstrap-js', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js', array('jquery'), null, true);
    }
    
    // Enqueue other necessary scripts and styles
    ...
    // Localize script to include the AJAX URL for potential AJAX requests
